...
<body>
            ...
            <div class="max-w-screen-xl px-4 py-3 mx-auto">
                ...
                >
                    ...
                    >
                        ...
                        <li class="relative group">
                            <a href="{{ url('/halamanprofile') }}" class="block px-4 py-2 text-gray-900 dark:text-white bg-blue-400 hover:text-white rounded-lg">
                                Profil
                            </a>
                        </li>
                        <li class="relative group">
        ...
        <div class="pt-10 sm:pt-20 pb-5 sm:pb-0">
            <div class="flex flex-row items-center justify-between px-4 mx-auto max-w-screen-xl text-center h-20 bg-[#475569] w-full rounded-lg">
                ...
                <p class="mb-4 text-1xl font-bold tracking-tight leading-none text-white md:text-2xl lg:text-4xl">
                    Sejarah Jurusan Teknik Komputer & Jaringan
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="relative bg-[#475569] py-12">
        <div class="mx-auto max-w-5xl bg-gray-700 rounded-lg shadow-lg p-6">
            <div class="bg-[#7C93C3] rounded-lg p-6">
                <p class="text-white mb-4">
                    Seiring dengan animo minat masyarakat pada awal tahun pelajaran 2003/2004, Sekolah Menengah Kejuruan Negeri 2 Indramayu hanya membuka 3 (tiga) Program Keahlian sebagai berikut:
                </p>
                <ul class="list-disc pl-5 mb-4 text-white">
                    <li>Nautika Pertanian Laut (NPL).</li>
                    <li>Teknologi Hasil Pertanian (THP).</li>
                    <li>Teknik Informatika Komersial (TIK).</li>
                </ul>
                <p class="text-white mb-4">
                    Dalam perjalanannya, SMK Negeri 2 Indramayu mengalami beberapa perubahan. Pada tahun pelajaran 2004/2005, beberapa program keahlian mengalami perubahan nama sesuai dengan perubahan Kurikulum SMK 2004, yaitu:
                </p>
                <ul class="list-disc pl-5 text-white">
                    <li>Teknologi Hasil Pertanian (THP) menjadi <strong>Teknologi Pengolahan Hasil Pertanian (TPHP)</strong>.</li>
                    <li>Teknik Informatika Komersial (TIK) menjadi <strong>Teknik Komputer dan Jaringan (TKJ)</strong>.</li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="pt-10">
            <div class="flex flex-row items-center justify-between px-4 mx-auto max-w-screen-xl text-center h-20 bg-[#475569] w-full rounded-lg">
                <img src="{{ asset('img/logotkj.png') }}" class="h-24 sm:h-40" alt="Logo" />
                <p class="mb-4 text-1xl font-bold tracking-tight leading-none text-white md:text-2xl lg:text-4xl">
                    Tujuan Dan Kompetensi Yang Didapat
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="relative bg-[#475569] py-12">
        <div class="mx-auto max-w-5xl bg-gray-700 rounded-lg shadow-lg p-6">
            <div class="bg-[#7C93C3] rounded-lg p-6">
                <h2 class="text-2xl font-bold text-white mb-4">Tujuan</h2>
                <p class="text-white mb-6">
                    Mendidik peserta agar dapat menerapkan sehat, memiliki wawasan pengetahuan, teknologi dan informasi serta mempunyai keahlian dan keterampilan dalam kompetensi keahlian Teknik Komputer dan Jaringan sehingga dapat bekerja secara mandiri maupun mengisi pekerjaan yang ada di Dunia Usaha / Dunia Industri (DU/DI) sebagai tenaga kerja tingkat menengah dengan menetapkan standar mutu pendidikan sesuai dengan standar internasional.
                </p>
                <h2 class="text-2xl font-bold text-white mb-4">Kompetensi yang Didapat</h2>
                <ul class="list-disc pl-5 text-white space-y-2">
                    <li>Merakit Personal Computer (PC).</li>
                    <li>Melakukan Instalasi Sistem Operasi Dasar.</li>
                    <li>Melakukan Instalasi LAN dan WAN.</li>
                    <li>Mengidentifikasi spesifikasi produk server, keterbatasan, dan kelemahan server.</li>
                    <li>Merencanakan langkah setting ulang koneksi jaringan.</li>
                    <li>Melakukan Instalasi Sistem Operasi Jaringan berbasis GUI (Graphical User Interface) dan Text.</li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <section class="relative py-12 sm:py-20">
        <div class="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Card 1 -->
            <div class="relative bg-[#475569] rounded-lg shadow-lg p-6">
                <div class="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-[#38BDF8] w-12 h-12 rounded-full flex items-center justify-center shadow-md">
                    <span class="text-white text-xl font-bold">1</span>
                </div>
                <h3 class="text-white text-lg font-semibold mb-4 text-center">Kelas X</h3>
                <ul class="text-white space-y-2">
                    <li>- System computer dan jaringan</li>
                    <li>- Desain grafis</li>
            ...
            <div class="relative bg-[#475569] rounded-lg shadow-lg p-6">
                ...
                <h3 class="text-white text-lg font-semibold mb-4 text-center">Kelas XI</h3>
                <ul class="text-white space-y-2">
                    <li>- Teknologi layanan jaringan</li>
                    <li>- Administrasi infrastruktur jaringan</li>
                    <li>- Administrasi system jaringan</li>
                    <li>- Teknologi WAN</li>
                    <li>- Kewirausahaan</li>
                </ul>
            </div>
            ...
            <div class="relative bg-[#475569] rounded-lg shadow-lg p-6">
                ...
                <h3 class="text-white text-lg font-semibold mb-4 text-center">Kelas XII</h3>
                <ul class="text-white space-y-2">
