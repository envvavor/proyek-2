...
<body>
            ...
            <div class="max-w-screen-xl px-4 py-3 mx-auto">
                ...
                >
                    ...
                    >
                        ...
                        <li class="relative group">
                            <a href="{{ url('/halamansarana') }}" class="block px-4 py-2 text-gray-900 dark:text-white bg-blue-400 hover:text-white rounded-lg">
                                Sarana & Prasarana
                            </a>
                        </li>
                        <li class="relative group">
    ...
    <section>
        <div class="pt-10 sm:pt-20 pb-5 sm:pb-0">
            <div class="flex flex-row items-center justify-between px-4 mx-auto max-w-screen-xl text-center h-20 bg-[#475569] w-full rounded-lg shadow-2xl">
                ...
                <p class="mb-4 text-1xl font-bold tracking-tight leading-none text-white md:text-2xl lg:text-4xl">
                    Laboratorium Jurusan Teknik Komputer & Jaringan
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="relative bg-[#475569] py-12">
        <div class="flex flex-wrap justify-center gap-6">
            <!-- Card 1 -->
            <div class="max-w-xs md:max-w-sm bg-white border border-gray-800 rounded-lg shadow">
                <a href="#">
                    <img class="rounded-t-lg" src="{{ asset('img/image7.jpg') }}"/>
                </a>
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Laboratorium TKJ</h5>
                    </a>
                </div>
            </div>
    ...
    <section>
        <div class="pt-5">
            <div class="flex flex-row items-center justify-between px-4 mx-auto max-w-screen-xl text-center h-20 bg-[#475569] w-full rounded-lg">
                <img src="{{ asset('img/logotkj.png') }}" class="h-24 sm:h-40" alt="Logo" />
                <p class="mb-4 text-1xl font-bold tracking-tight leading-none text-white md:text-2xl lg:text-4xl">
                    Prasarana Ujikom Jurusan Teknik Komputer & Jaringan
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="relative bg-[#475569] py-12">
        <div class="flex flex-wrap justify-center gap-6">
            ...
            <div class="max-w-sm bg-white border border-gray-800 rounded-lg shadow">
                ...
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Prasarana Ujikom</h5>
                    </a>
                </div>
            </div>
    ...
    <section>
        <div class="pt-5">
            <div class="flex flex-row items-center justify-between px-4 mx-auto max-w-screen-xl text-center h-20 bg-[#475569] w-full rounded-lg">
                <img src="{{ asset('img/logotkj.png') }}" class="h-24 sm:h-40" alt="Logo" />
                <p class="mb-4 text-1xl font-bold tracking-tight leading-none text-white md:text-2xl lg:text-4xl">
                    Sarana Jurusan Teknik Komputer & Jaringan
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="relative py-12 sm:py-20">
        <div class="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="relative bg-[#475569] rounded-lg shadow-lg p-6">
                ...
                <div class="text-white text-center font-semibold m-5">
                    <p>Komputer</p>
                    <p>PC</p>
                    <p>Wifi</p>
                </div>
            ...
            <div class="relative bg-[#475569] rounded-lg shadow-lg p-6">
                ...
                <div class="text-white text-center font-semibold m-5">
                    <p>
                        Peralatan praktikum yang lengkap disesuaikan dengan mata pelajaran
                    </p>
                </div>
            </div>
            <!-- Card 3 -->
            <div class="relative bg-[#475569] rounded-lg shadow-lg p-6">
                ...
                <div class="text-white text-center font-semibold m-5">
                    <p>
                        Buku praktikum dan modul </br> yang lengkap
                    </p>
                </div>
            </div>
        </div>
