            ...
            <div class="max-w-screen-xl px-4 py-3 mx-auto">
                ...
                >
                    ...
                    >
                        ...
                        <li class="relative group">
                            <a href="{{ url('/halamanhubungan') }}" class="block px-4 py-2 text-gray-900 dark:text-white bg-blue-400 hover:text-white rounded-lg">
                                Hubungan Industri
                            </a>
                        </li>
                        <li class="relative group">
        ...
        <div href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow-lg md:flex-row md:max-w-6xl">
            ...
            <div class="flex flex-col justify-between p-8 leading-normal w-full md:w-1/2">
                ...
                <p class="mb-4 text-lg font-medium text-gray-700">
                    Dunia usaha dan dunia industri adalah suatu bidang yang bersifat komersial yang menggunakan ketrampilan kerja siswa siswi untuk membuat atau menghasilkan pada bidang pekerjaan yang digeluti selama masa Praktek Kerja Lapangan baik yang berupa jasa maupun non jasa, yang dilakukan selama kurang lebih 6 bulan.
                </p>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="py-10">
            <div class="flex flex-row items-center justify-between px-4 mx-auto max-w-screen-xl text-center h-20 bg-[#475569] w-full rounded-lg">
                <img src="{{ asset('img/logotkj.png') }}" class="h-24 sm:h-40" alt="Logo" />
                <p class="mb-4 text-1xl font-bold tracking-tight leading-none text-white md:text-2xl lg:text-4xl">
                    Galeri Siswa Melaksanakan Kerja Dunia Industri
                </p>
            </div>
        </div>
    </section>
