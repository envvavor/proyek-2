...
<body>
            ...
            <div class="max-w-screen-xl px-4 py-3 mx-auto">
                ...
                >
                    ...
                    >
                        ...
                        <li class="relative group">
                            <a href="{{ url('/halamankontak') }}" class="block px-4 py-2 text-gray-900 dark:text-white bg-blue-400 hover:text-white rounded-lg">
                                Kontak
                            </a>
                        </li>
                    </ul>
    ...
    <section class="relative bg-[#475569] py-12">
        <div class="mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-20 sm:gap-8">
            <!-- Form Kiri -->
            <div class="bg-[#1E293B] rounded-lg p-8 shadow-lg relative">
                <!-- Logo -->
                <div class="absolute -top-10 left-1/2 transform -translate-x-1/2 bg-white w-20 h-20 rounded-full flex items-center justify-center shadow-md">
                    <img src="{{ asset('img/logotkj.png') }}" alt="Logo TKJ" class="w-16 h-16" style="margin-left: 7px;">
                </div>
                <!-- Form -->
                <form class="mt-12">
                    <label class="block text-white mb-2">Email</label>
                    <input type="email" placeholder="Masukkan Email" class="w-full mb-4 p-3 rounded bg-[#475569] text-white focus:outline-none focus:ring-2 focus:ring-[#38BDF8]">
                    
                    <label class="block text-white mb-2">Nomor Telp</label>
                    <input type="tel" placeholder="Masukkan Nomor Telephone" class="w-full mb-4 p-3 rounded bg-[#475569] text-white focus:outline-none focus:ring-2 focus:ring-[#38BDF8]">
                    
                    <label class="block text-white mb-2">Tinggalkan Pesan</label>
                    <textarea placeholder="Ketikkan Kritik atau Saran" rows="4" class="w-full mb-6 p-3 rounded bg-[#475569] text-white focus:outline-none focus:ring-2 focus:ring-[#38BDF8]"></textarea>
                    
                    <button type="submit" class="w-full bg-[#38BDF8] text-white py-3 rounded shadow hover:bg-[#2A91D1] transition">KIRIM</button>
                </form>
            </div>
            ...
            <div class="bg-[#1E293B] rounded-lg p-8 shadow-lg relative">
                ...
                <div class="mt-12 space-y-4">
                    <div class="bg-[#475569] p-4 rounded text-white">
                        <p>Nomor Telp : +62 809-364-265-12</p>
                    </div>
                    <div class="bg-[#475569] p-4 rounded text-white">
                        <p>Nomor Telp : +62 734-864-112-45</p>
                    </div>
                    <div class="bg-[#475569] p-4 rounded text-white">
                        <p>Email : smkn2indramayutkj@gmail.com</p>
                    </div>
                    <div class="bg-[#475569] p-4 rounded text-white">
                        <p>Email : jurusantkj@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
...
<footer class="bg-[#475569] rounded-lg shadow m-4 mt-20">
